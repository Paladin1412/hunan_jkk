export const AREA_ITEMS = [
    {
        children: [
            {
                children: [
                    { value: '900002', label: '伊朗' },
                    { value: '900003', label: '意大利' },
                    { value: '900004', label: '韩国' },
                    { value: '900005', label: '日本' },
                    { value: '900001', label: '其他' },
                ],
                value: '900001',
                label: '其他国家',
            },
    ...
    },
    {
        children: [
            ...
            {
                children: [
                    { value: '139002205', label: '中里厢乡' },
                    { value: '1390025', label: '辛集经济开发区' },
                    { value: '139002202', label: '马庄乡' },
                    { value: '139002203', label: '和睦井乡' },
                    { value: '139002204', label: '田家庄乡' },
                    { value: '1390021', label: '辛集镇' },
                    { value: '1390022', label: '天宫营乡' },
                    { value: '139002201', label: '前营乡' },
                    { value: '139002206', label: '小辛庄乡' },
                    { value: '139002103', label: '位伯镇' },
                    { value: '139002102', label: '张古庄镇' },
                    { value: '139002101', label: '旧城镇' },
                    { value: '139002107', label: '王口镇' },
                    { value: '139002106', label: '南智邱镇' },
                    { value: '139002105', label: '新城镇' },
                    { value: '139002104', label: '新垒头镇' },
                ],
                value: '139002',
                label: '辛集市',
            },
            ...
            {
                children: [
                    { value: '13900111', label: '邢邑镇' },
                    { value: '1390011', label: '留早镇' },
                    { value: '139001208', label: '西城乡' },
                    { value: '139001205', label: '杨家庄乡' },
                    { value: '139001204', label: '号头庄回族乡' },
                    { value: '139001206', label: '大鹿庄乡' },
                    { value: '139001203', label: '东留春乡' },
                    { value: '139001115', label: '周村镇' },
                    { value: '139001116', label: '息冢镇' },
                    { value: '139001111', label: '李亲顾镇' },
                    { value: '139001113', label: '开元镇' },
                    { value: '139001112', label: '子位镇' },
                    { value: '139001001', label: '南城区街道' },
                    { value: '139001106', label: '东亭镇' },
                    { value: '139001107', label: '大辛庄镇' },
                    { value: '139001104', label: '明月店镇' },
                    { value: '139001105', label: '叮咛店镇' },
                    { value: '139001102', label: '庞村镇' },
                    { value: '139001103', label: '砖路镇' },
                    { value: '139001101', label: '清风店镇' },
                    { value: '139001004', label: '长安路街道' },
                    { value: '139001003', label: '西城区街道' },
                    { value: '139001002', label: '北城区街道' },
                    { value: '139001108', label: '东旺镇' },
                    { value: '139001109', label: '高蓬镇' },
                ],
                value: '139001',
                label: '定州市',
            },
    ...
    },
    {
        children: [
            ...
            {
                children: [
                    { value: '419001109', label: '济源市王屋镇' },
                    { value: '419001001', label: '济源市沁园街道' },
                    { value: '419001002', label: '济源市济水街道' },
                    { value: '419001003', label: '济源市北海街道' },
                    { value: '419001004', label: '济源市天坛街道' },
                    { value: '419001005', label: '济源市玉泉街道' },
                    { value: '4190011', label: '济源市克井镇' },
                    { value: '419001101', label: '济源市五龙口镇' },
                    { value: '419001108', label: '济源市思礼镇' },
                    { value: '419001103', label: '济源市承留镇' },
                    { value: '419001102', label: '济源市轵城镇' },
                    { value: '419001105', label: '济源市坡头镇' },
                    { value: '419001104', label: '济源市邵原镇' },
                    { value: '419001107', label: '济源市大峪镇' },
                    { value: '419001106', label: '济源市梨林镇' },
                    { value: '41900111', label: '济源市下冶镇' },
                ],
                value: '419001',
                label: '济源市',
            },
    ...
    },
    {
        children: [
            ...
            {
                children: [
                    { value: '429021105', label: '九湖镇' },
                    { value: '429021202', label: '下谷坪土家族乡' },
                    { value: '4290211', label: '松柏镇' },
                    { value: '429021104', label: '新华镇' },
                    { value: '4290212', label: '宋洛乡' },
                    { value: '429021102', label: '木鱼镇' },
                    { value: '429021103', label: '红坪镇' },
                    { value: '429021101', label: '阳日镇' },
                ],
                value: '429021',
                label: '神农架林区',
            },
            ...
            {
                children: [
                    { value: '429005005', label: '泰丰' },
                    { value: '429005004', label: '广华' },
                    { value: '429005006', label: '高场' },
                    { value: '429005001', label: '园林' },
                    { value: '429005003', label: '周矶' },
                    { value: '429005002', label: '杨市' },
                    { value: '4290051', label: '竹根滩镇' },
                    { value: '4290054', label: '江汉石油管理局' },
                    { value: '42900545', label: '周矶管理区' },
                    { value: '429005103', label: '高石碑镇' },
                    { value: '429005401', label: '潜江经济开发区' },
                    { value: '429005457', label: '浩口原种场' },
                    { value: '429005454', label: '白鹭湖管理区' },
                    { value: '429005455', label: '运粮湖管理区' },
                    { value: '429005101', label: '渔洋镇' },
                    { value: '429005108', label: '张金镇' },
                    { value: '429005109', label: '龙湾镇' },
                    { value: '429005104', label: '熊口镇' },
                    { value: '429005105', label: '老新镇' },
                    { value: '429005106', label: '浩口镇' },
                    { value: '429005107', label: '积玉口镇' },
                    { value: '429005452', label: '熊口管理区' },
                    { value: '429005453', label: '总口管理区' },
                    { value: '429005102', label: '王场镇' },
                    { value: '429005451', label: '后湖管理区' },
                ],
                value: '429005',
                label: '潜江市',
            },
            {
                children: [
                    { value: '429004002', label: '干河街道' },
                    { value: '429004003', label: '龙华山' },
                    { value: '429004001', label: '沙嘴街道' },
                    { value: '429004107', label: '沙湖镇' },
                    { value: '429004106', label: '西流河镇' },
                    { value: '429004105', label: '长倘口镇' },
                    { value: '429004104', label: '胡场镇' },
                    { value: '429004103', label: '三伏潭镇' },
                    { value: '429004102', label: '豆河镇' },
                    { value: '429004101', label: '毛嘴镇' },
                    { value: '429004109', label: '彭场镇' },
                    { value: '429004108', label: '杨林尾镇' },
                    { value: '429004408', label: '排湖风景区' },
                    { value: '429004402', label: '沙湖原种场' },
                    { value: '4290041', label: '郑场镇' },
                    { value: '429004401', label: '九合垸原种场' },
                    { value: '4290044', label: '工业园区' },
                    { value: '429004407', label: '畜禽良种场' },
                    { value: '429004404', label: '五湖渔场' },
                    { value: '429004405', label: '赵西垸林场' },
                    { value: '42900411', label: '张沟镇' },
                    { value: '429004111', label: '郭河镇' },
                    { value: '429004112', label: '沔城回族镇' },
                    { value: '429004113', label: '通海口镇' },
                    { value: '429004114', label: '陈场镇' },
                ],
                value: '429004',
                label: '仙桃市',
            },
            ...
            {
                children: [
                    { value: '429006201', label: '净潭乡' },
                    { value: '429006452', label: '沉湖管委会' },
                    { value: '429006451', label: '白茅湖农场' },
                    { value: '42900611', label: '麻洋镇' },
                    { value: '42900612', label: '石河镇' },
                    { value: '429006121', label: '佛子山镇' },
                    { value: '4290061', label: '多宝镇' },
                    { value: '429006109', label: '彭市镇' },
                    { value: '429006108', label: '横林镇' },
                    { value: '429006002', label: '侨乡街道开发区' },
                    { value: '429006003', label: '杨林街道' },
                    { value: '429006105', label: '渔薪镇' },
                    { value: '429006104', label: '汪场镇' },
                    { value: '429006107', label: '岳口镇' },
                    { value: '429006106', label: '黄潭镇' },
                    { value: '429006101', label: '拖市镇' },
                    { value: '429006103', label: '蒋场镇' },
                    { value: '429006001', label: '竟陵街道' },
                    { value: '42900645', label: '蒋湖农场' },
                    { value: '429006102', label: '张港镇' },
                    { value: '429006118', label: '皂市镇' },
                    { value: '429006119', label: '胡市镇' },
                    { value: '429006116', label: '九真镇' },
                    { value: '429006114', label: '卢市镇' },
                    { value: '429006115', label: '小板镇' },
                    { value: '429006112', label: '干驿镇' },
                    { value: '429006113', label: '马湾镇' },
                    { value: '429006111', label: '多祥镇' },
                ],
                value: '429006',
                label: '天门市',
            },
        ...
        children: [
            ...
            },
            {
                children: [
                    ...
                    { value: '441900402', label: '虎门港管委会' },
                    { value: '441900123', label: '沙田镇' },
                    { value: '441900401', label: '松山湖管委会' },
    ...
    },
    {
        children: [
            {
                children: [
                    { value: '4690214', label: '国营中瑞农场' },
                    { value: '4690211', label: '定城镇' },
                    { value: '469021102', label: '龙湖镇' },
                    { value: '469021103', label: '黄竹镇' },
                    { value: '469021101', label: '新竹镇' },
                    { value: '469021106', label: '龙河镇' },
                    { value: '469021107', label: '岭口镇' },
                    { value: '469021104', label: '雷鸣镇' },
                    { value: '469021105', label: '龙门镇' },
                    { value: '469021108', label: '翰林镇' },
                    { value: '469021109', label: '富文镇' },
                    { value: '469021402', label: '国营金鸡岭农场' },
                    { value: '469021401', label: '国营南海农场' },
                ],
                value: '469021',
                label: '定安县',
            },
            {
                children: [
                    { value: '469023108', label: '福山镇' },
                    { value: '469023109', label: '桥头镇' },
                    { value: '469023104', label: '加乐镇' },
                    { value: '469023105', label: '文儒镇' },
                    { value: '469023106', label: '中兴镇' },
                    { value: '469023107', label: '仁兴镇' },
                    { value: '469023101', label: '老城镇' },
                    { value: '469023102', label: '瑞溪镇' },
                    { value: '469023103', label: '永发镇' },
                    { value: '469023402', label: '国营西达农场' },
                    { value: '469023405', label: '国营金安农场' },
                    { value: '4690231', label: '金江镇' },
                    { value: '4690234', label: '国营红光农场' },
                    { value: '46902311', label: '大丰镇' },
                ],
                value: '469023',
                label: '澄迈县',
            },
            {
                children: [
                    { value: '469022107', label: '西昌镇' },
                    { value: '469022106', label: '坡心镇' },
                    { value: '469022105', label: '南坤镇' },
                    { value: '469022104', label: '南吕镇' },
                    { value: '469022103', label: '乌坡镇' },
                    { value: '469022102', label: '枫木镇' },
                    { value: '469022101', label: '新兴镇' },
                    { value: '4690221', label: '屯城镇' },
                    { value: '469022401', label: '国营中坤农场' },
                    { value: '4690224', label: '国营中建农场' },
                ],
                value: '469022',
                label: '屯昌县',
            },
            {
                children: [
                    { value: '4690251', label: '牙叉镇' },
                    { value: '4690252', label: '细水乡' },
                    { value: '469025205', label: '金波乡' },
                    { value: '469025204', label: '青松乡' },
                    { value: '469025206', label: '荣邦乡' },
                    { value: '469025201', label: '元门乡' },
                    { value: '469025203', label: '阜龙乡' },
                    { value: '469025202', label: '南开乡' },
                    { value: '469025408', label: '国营邦溪农场' },
                    { value: '469025102', label: '邦溪镇' },
                    { value: '469025103', label: '打安镇' },
                    { value: '469025101', label: '七坊镇' },
                    { value: '469025401', label: '国营白沙农场' },
                    { value: '469025404', label: '国营龙江农场' },
                ],
                value: '469025',
                label: '白沙黎族自治县',
            },
            {
                children: [
                    { value: '469024401', label: '国营加来农场' },
                    { value: '469024101', label: '波莲镇' },
                    { value: '469024103', label: '博厚镇' },
                    { value: '469024102', label: '东英镇' },
                    { value: '469024105', label: '多文镇' },
                    { value: '469024104', label: '皇桐镇' },
                    { value: '469024107', label: '南宝镇' },
                    { value: '469024106', label: '和舍镇' },
                    { value: '469024109', label: '调楼镇' },
                    { value: '469024108', label: '新盈镇' },
                    { value: '4690244', label: '国营红华农场' },
                    { value: '4690241', label: '临城镇' },
                ],
                value: '469024',
                label: '临高县',
            },
            {
                children: [
                    { value: '469027106', label: '利国镇' },
                    { value: '46902711', label: '莺歌海镇' },
                    { value: '469027405', label: '国营保国农场' },
                    { value: '469027102', label: '大安镇' },
                    { value: '469027101', label: '万冲镇' },
                    { value: '4690275', label: '国营尖峰岭林业公司' },
                    { value: '469027103', label: '志仲镇' },
                    { value: '469027104', label: '千家镇' },
                    { value: '469027105', label: '九所镇' },
                    { value: '4690271', label: '抱由镇' },
                    { value: '469027107', label: '黄流镇' },
                    { value: '469027108', label: '佛罗镇' },
                    { value: '469027109', label: '尖峰镇' },
                    { value: '469027401', label: '国营山荣农场' },
                    { value: '469027501', label: '国营莺歌海盐场' },
                    { value: '469027402', label: '国营乐光农场' },
                ],
                value: '469027',
                label: '乐东黎族自治县',
            },
            ...
            },
            {
                children: [
                    ...
                    { value: '460400407', label: '国营八一农场' },
                    { value: '460400405', label: '国营蓝洋农场' },
                    { value: '460400404', label: '国营西联农场' },
            ...
            {
                children: [
                    { value: '469002403', label: '国营东升农场' },
                    { value: '469002402', label: '国营东红农场' },
                    { value: '469002111', label: '会山镇' },
                    { value: '46900211', label: '大路镇' },
                    { value: '469002105', label: '阳江镇' },
                    { value: '469002104', label: '博鳌镇' },
                    { value: '469002107', label: '潭门镇' },
                    { value: '469002106', label: '龙江镇' },
                    { value: '469002101', label: '万泉镇' },
                    { value: '469002103', label: '中原镇' },
                    { value: '469002102', label: '石壁镇' },
                    { value: '4690021', label: '嘉积镇' },
                    { value: '469002109', label: '长坡镇' },
                    { value: '469002108', label: '塔洋镇' },
                    { value: '4690024', label: '国营东太农场' },
                    { value: '4690025', label: '彬村山华侨农场' },
                ],
                value: '469002',
                label: '琼海市',
            },
            {
                children: [
                    { value: '4690012', label: '畅好乡' },
                    { value: '4690011', label: '通什镇' },
                    { value: '469001101', label: '南圣镇' },
                    { value: '469001102', label: '毛阳镇' },
                    { value: '4690014', label: '畅好农场' },
                    { value: '469001103', label: '番阳镇' },
                    { value: '469001202', label: '水满乡' },
                    { value: '469001201', label: '毛道乡' },
                ],
                value: '469001',
                label: '五指山市',
            },
            {
                children: [
                    { value: '4690265', label: '国营霸王岭林场' },
                    { value: '4690261', label: '石碌镇' },
                    { value: '4690262', label: '王下乡' },
                    { value: '469026401', label: '国营红林农场' },
                    { value: '469026103', label: '乌烈镇' },
                    { value: '469026102', label: '十月田镇' },
                    { value: '469026101', label: '叉河镇' },
                    { value: '469026105', label: '海尾镇' },
                    { value: '469026106', label: '七叉镇' },
                    { value: '469026501', label: '海南矿业联合有限公司' },
                    { value: '469026104', label: '昌化镇' },
                ],
                value: '469026',
                label: '昌江黎族自治县',
            },
            {
                children: [
                    { value: '469007201', label: '江边乡' },
                    { value: '4690071', label: '八所镇' },
                    { value: '4690072', label: '天安乡' },
                    { value: '4690075', label: '东方华侨农场' },
                    { value: '4690074', label: '国营广坝农场' },
                    { value: '469007106', label: '四更镇' },
                    { value: '469007107', label: '新龙镇' },
                    { value: '469007104', label: '板桥镇' },
                    { value: '469007105', label: '三家镇' },
                    { value: '469007102', label: '大田镇' },
                    { value: '469007103', label: '感城镇' },
                    { value: '469007101', label: '东河镇' },
                ],
                value: '469007',
                label: '东方市',
            },
            {
                children: [
                    { value: '469006404', label: '国营新中农场' },
                    { value: '469006111', label: '三更罗镇' },
                    { value: '469006501', label: '地方国营六连林场' },
                    { value: '46900611', label: '南桥镇' },
                    { value: '469006109', label: '北大镇' },
                    { value: '469006108', label: '山根镇' },
                    { value: '4690064', label: '国营东兴农场' },
                    { value: '4690065', label: '兴隆华侨农场' },
                    { value: '469006401', label: '国营东和农场' },
                    { value: '4690061', label: '万城镇' },
                    { value: '469006101', label: '龙滚镇' },
                    { value: '469006103', label: '后安镇' },
                    { value: '469006102', label: '和乐镇' },
                    { value: '469006105', label: '东澳镇' },
                    { value: '469006104', label: '大茂镇' },
                    { value: '469006107', label: '长丰镇' },
                    { value: '469006106', label: '礼纪镇' },
                ],
                value: '469006',
                label: '万宁市',
            },
            {
                children: [
                    { value: '469005401', label: '国营南阳农场' },
                    { value: '469005116', label: '公坡镇' },
                    { value: '46900511', label: '昌洒镇' },
                    { value: '469005114', label: '锦山镇' },
                    { value: '469005113', label: '冯坡镇' },
                    { value: '469005112', label: '抱罗镇' },
                    { value: '469005111', label: '翁田镇' },
                    { value: '469005402', label: '国营罗豆农场' },
                    { value: '4690054', label: '国营东路农场' },
                    { value: '469005115', label: '铺前镇' },
                    { value: '4690051', label: '文城镇' },
                    { value: '469005108', label: '东郊镇' },
                    { value: '469005109', label: '龙楼镇' },
                    { value: '469005101', label: '重兴镇' },
                    { value: '469005102', label: '蓬莱镇' },
                    { value: '469005103', label: '会文镇' },
                    { value: '469005104', label: '东路镇' },
                    { value: '469005105', label: '潭牛镇' },
                    { value: '469005106', label: '东阁镇' },
                    { value: '469005107', label: '文教镇' },
                ],
                value: '469005',
                label: '文昌市',
            },
            {
                children: [
                    { value: '4690292', label: '六弓乡' },
                    { value: '469029405', label: '国营三道农场' },
                    { value: '469029403', label: '国营金江农场' },
                    { value: '469029402', label: '海南保亭热带作物研究所' },
                    { value: '469029401', label: '国营新星农场' },
                    { value: '469029201', label: '南林乡' },
                    { value: '469029202', label: '毛感乡' },
                    { value: '469029102', label: '加茂镇' },
                    { value: '469029103', label: '响水镇' },
                    { value: '469029101', label: '什玲镇' },
                    { value: '4690291', label: '保城镇' },
                    { value: '469029104', label: '新政镇' },
                    { value: '469029105', label: '三道镇' },
                ],
                value: '469029',
                label: '保亭黎族苗族自治县',
            },
            ...
            {
                children: [
                    { value: '469028201', label: '群英乡' },
                    { value: '469028401', label: '国营南平农场' },
                    { value: '469028105', label: '文罗镇' },
                    { value: '469028104', label: '隆广镇' },
                    { value: '469028107', label: '新村镇' },
                    { value: '469028106', label: '本号镇' },
                    { value: '469028101', label: '光坡镇' },
                    { value: '469028103', label: '英州镇' },
                    { value: '469028102', label: '三才镇' },
                    { value: '4690282', label: '提蒙乡' },
                    { value: '4690281', label: '椰林镇' },
                    { value: '469028108', label: '黎安镇' },
                    { value: '4690284', label: '国营岭门农场' },
                    { value: '4690285', label: '国营吊罗山林业公司' },
                ],
                value: '469028',
                label: '陵水黎族自治县',
            },
            {
                children: [
                    { value: '469030202', label: '什运乡' },
                    { value: '469030201', label: '上安乡' },
                    { value: '469030104', label: '长征镇' },
                    { value: '469030105', label: '红毛镇' },
                    { value: '469030106', label: '中平镇' },
                    { value: '469030101', label: '湾岭镇' },
                    { value: '469030102', label: '黎母山镇' },
                    { value: '469030103', label: '和平镇' },
                    { value: '469030403', label: '国营乌石农场' },
                    { value: '469030402', label: '国营阳江农场' },
                    { value: '469030407', label: '国营长征农场' },
                    { value: '469030406', label: '国营加钗农场' },
                    { value: '4690302', label: '吊罗山乡' },
                    { value: '4690301', label: '营根镇' },
                    {
                        value: '4690305',
                        label: '海南黎母山省级自然保护区管理站',
                    },
                ],
                value: '469030',
                label: '琼中黎族苗族自治县',
    ...
    },
    {
        children: [
            {
                children: [
                    { value: '500232212', label: '接龙乡' },
                    { value: '500232213', label: '赵家乡' },
                    { value: '500232211', label: '浩口苗族仡佬族乡' },
                    { value: '500232214', label: '大洞河乡' },
                    { value: '50023211', label: '土坎镇' },
                    { value: '5002321', label: '巷口镇' },
                    { value: '5002322', label: '凤来乡' },
                    { value: '500232102', label: '白马镇' },
                    { value: '500232103', label: '鸭江镇' },
                    { value: '500232101', label: '火炉镇' },
                    { value: '500232106', label: '平桥镇' },
                    { value: '500232107', label: '羊角镇' },
                    { value: '500232104', label: '长坝镇' },
                    { value: '500232105', label: '江口镇' },
                    { value: '500232108', label: '仙女山镇' },
                    { value: '500232109', label: '桐梓镇' },
                    { value: '500232209', label: '白云乡' },
                    { value: '500232208', label: '土地乡' },
                    { value: '500232203', label: '石桥苗族土家族乡' },
                    { value: '500232202', label: '庙垭乡' },
                    { value: '500232205', label: '黄莺乡' },
                    { value: '500232207', label: '文复苗族土家族乡' },
                    { value: '500232206', label: '沧沟乡' },
                    { value: '50023221', label: '后坪苗族土家族乡' },
                    { value: '500232111', label: '和顺镇' },
                    { value: '500232112', label: '双河镇' },
                ],
                value: '500232',
                label: '武隆县',
            },
            {
                children: [
                    { value: '50023311', label: '官坝镇' },
                    { value: '50023312', label: '白石镇' },
                    { value: '500233118', label: '永丰镇' },
                    { value: '500233119', label: '三汇镇' },
                    { value: '500233116', label: '拔山镇' },
                    { value: '500233117', label: '花桥镇' },
                    { value: '500233114', label: '新立镇' },
                    { value: '500233115', label: '双桂镇' },
                    { value: '500233112', label: '马灌镇' },
                    { value: '500233113', label: '金鸡镇' },
                    { value: '500233111', label: '石黄镇' },
                    { value: '500233206', label: '涂井乡' },
                    { value: '500233204', label: '磨子土家族乡' },
                    { value: '500233203', label: '石子乡' },
                    { value: '500233201', label: '善广乡' },
                    { value: '500233208', label: '金声乡' },
                    { value: '50023321', label: '兴峰乡' },
                    { value: '500233108', label: '汝溪镇' },
                    { value: '500233122', label: '黄金镇' },
                    { value: '500233109', label: '野鹤镇' },
                    { value: '500233001', label: '忠州街道' },
                    { value: '500233002', label: '白公街道' },
                    { value: '500233105', label: '东溪镇' },
                    { value: '500233104', label: '洋渡镇' },
                    { value: '500233107', label: '石宝镇' },
                    { value: '500233106', label: '复兴镇' },
                    { value: '500233101', label: '新生镇' },
                    { value: '500233103', label: '乌杨镇' },
                    { value: '500233102', label: '任家镇' },
                ],
                value: '500233',
                label: '忠县',
            },
            {
                children: [
                    { value: '500230', label: '名山街道' },
                    { value: '50023021', label: '三建乡' },
                    { value: '500230209', label: '栗子乡' },
                    { value: '500230207', label: '都督乡' },
                    { value: '500230206', label: '太平坝乡' },
                    { value: '500230109', label: '高家镇' },
                    { value: '500230104', label: '许明寺镇' },
                    { value: '500230105', label: '董家镇' },
                    { value: '500230106', label: '树人镇' },
                    { value: '500230107', label: '十直镇' },
                    { value: '500230101', label: '虎威镇' },
                    { value: '500230102', label: '社坛镇' },
                    { value: '500230103', label: '三元镇' },
                    { value: '500230124', label: '双龙镇' },
                    { value: '500230125', label: '仙女湖镇' },
                    { value: '500230122', label: '龙孔镇' },
                    { value: '500230123', label: '暨龙镇' },
                    { value: '500230121', label: '仁沙镇' },
                    { value: '50023012', label: '兴龙镇' },
                    { value: '50023011', label: '兴义镇' },
                    { value: '500230202', label: '青龙乡' },
                    { value: '500230119', label: '保合镇' },
                    { value: '500230118', label: '南天湖镇' },
                    { value: '500230113', label: '龙河镇' },
                    { value: '500230112', label: '江池镇' },
                    { value: '500230111', label: '双路镇' },
                    { value: '500230116', label: '湛普镇' },
                    { value: '500230115', label: '包鸾镇' },
                    { value: '500230114', label: '武平镇' },
                ],
                value: '500230',
                label: '丰都县',
            },
            {
                children: [
                    { value: '500231118', label: '永平镇' },
                    { value: '500231119', label: '三溪镇' },
                    { value: '500231202', label: '沙河乡' },
                    { value: '500231111', label: '鹤游镇' },
                    { value: '500231112', label: '坪山镇' },
                    { value: '500231113', label: '砚台镇' },
                    { value: '500231114', label: '曹回镇' },
                    { value: '500231115', label: '杠家镇' },
                    { value: '500231116', label: '包家镇' },
                    { value: '500231117', label: '白家镇' },
                    { value: '50023112', label: '裴兴镇' },
                    { value: '500231121', label: '黄沙镇' },
                    { value: '50023111', label: '太平镇' },
                    { value: '500231122', label: '长龙镇' },
                    { value: '500231002', label: '桂阳街道' },
                    { value: '500231001', label: '桂溪街道' },
                    { value: '500231107', label: '高峰镇' },
                    { value: '500231106', label: '高安镇' },
                    { value: '500231105', label: '永安镇' },
                    { value: '500231104', label: '普顺镇' },
                    { value: '500231103', label: '周嘉镇' },
                    { value: '500231102', label: '沙坪镇' },
                    { value: '500231101', label: '新民镇' },
                    { value: '500231204', label: '大石乡' },
                    { value: '500231109', label: '澄溪镇' },
                    { value: '500231108', label: '五洞镇' },
                ],
                value: '500231',
                label: '垫江县',
            },
            {
                children: [
                    { value: '500236265', label: '岩湾乡' },
                    { value: '500236266', label: '平安乡' },
                    { value: '500236117', label: '白帝镇' },
                    { value: '500236267', label: '红土乡' },
                    { value: '500236276', label: '长安土家族乡' },
                    { value: '500236119', label: '汾河镇' },
                    { value: '500236003', label: '夔门街道' },
                    { value: '500236002', label: '鱼复街道' },
                    { value: '500236001', label: '永安街道' },
                    { value: '500236118', label: '草堂镇' },
                    { value: '500236133', label: '五马镇' },
                    { value: '500236269', label: '石岗乡' },
                    { value: '500236132', label: '安坪镇' },
                    { value: '500236131', label: '永乐镇' },
                    { value: '50023613', label: '新民镇' },
                    { value: '50023612', label: '康乐镇' },
                    { value: '500236277', label: '龙桥土家族乡' },
                    { value: '500236134', label: '青莲镇' },
                    { value: '50023627', label: '康坪乡' },
                    { value: '500236272', label: '太和土家族乡' },
                    { value: '500236275', label: '冯坪乡' },
                    { value: '500236278', label: '云雾土家族乡' },
                    { value: '500236128', label: '兴隆镇' },
                    { value: '500236129', label: '青龙镇' },
                    { value: '500236124', label: '朱衣镇' },
                    { value: '500236125', label: '甲高镇' },
                    { value: '500236126', label: '羊市镇' },
                    { value: '500236127', label: '吐祥镇' },
                    { value: '500236274', label: '鹤峰乡' },
                    { value: '500236121', label: '大树镇' },
                    { value: '500236122', label: '竹园镇' },
                    { value: '500236123', label: '公平镇' },
                ],
                value: '500236',
                label: '奉节县',
            },
            {
                children: [
                    { value: '50023721', label: '建坪乡' },
                    { value: '500237101', label: '庙宇镇' },
                    { value: '500237001', label: '高唐街道' },
                    { value: '500237002', label: '龙门街道' },
                    { value: '500237208', label: '曲尺乡' },
                    { value: '500237219', label: '当阳乡' },
                    { value: '500237103', label: '福田镇' },
                    { value: '500237102', label: '大昌镇' },
                    { value: '500237105', label: '双龙镇' },
                    { value: '500237104', label: '龙溪镇' },
                    { value: '500237107', label: '骡坪镇' },
                    { value: '500237106', label: '官阳镇' },
                    { value: '500237109', label: '官渡镇' },
                    { value: '500237108', label: '抱龙镇' },
                    { value: '500237214', label: '金坪乡' },
                    { value: '500237231', label: '邓家乡' },
                    { value: '500237216', label: '平河乡' },
                    { value: '50023711', label: '铜鼓镇' },
                    { value: '500237222', label: '竹贤乡' },
                    { value: '500237111', label: '巫峡镇' },
                    { value: '500237225', label: '三溪乡' },
                    { value: '500237227', label: '培石乡' },
                    { value: '500237229', label: '笃坪乡' },
                    { value: '500237211', label: '大溪乡' },
                    { value: '5002372', label: '红椿乡' },
                    { value: '500237207', label: '两坪乡' },
                ],
                value: '500237',
                label: '巫山县',
            },
            {
                children: [
                    { value: '500241208', label: '大溪乡' },
                    { value: '500241201', label: '孝溪乡' },
                    { value: '500241207', label: '海洋乡' },
                    { value: '500241001', label: '中和街道' },
                    { value: '500241102', label: '清溪场镇' },
                    { value: '500241103', label: '隘口镇' },
                    { value: '500241104', label: '溶溪镇' },
                    { value: '500241105', label: '官庄镇' },
                    { value: '500241106', label: '龙池镇' },
                    { value: '500241107', label: '石堤镇' },
                    { value: '500241108', label: '峨溶镇' },
                    { value: '500241109', label: '洪安镇' },
                    { value: '500241003', label: '平凯街道' },
                    { value: '500241002', label: '乌杨街道' },
                    { value: '50024111', label: '雅江镇' },
                    { value: '500241214', label: '中平乡' },
                    { value: '500241215', label: '岑溪乡' },
                    { value: '500241211', label: '涌洞乡' },
                    { value: '500241119', label: '钟灵镇' },
                    { value: '500241118', label: '里仁镇' },
                    { value: '500241117', label: '宋农镇' },
                    { value: '500241116', label: '妙泉镇' },
                    { value: '500241115', label: '溪口镇' },
                    { value: '500241114', label: '膏田镇' },
                    { value: '500241113', label: '兰桥镇' },
                    { value: '500241112', label: '梅江镇' },
                    { value: '500241111', label: '石耶镇' },
                ],
                value: '500241',
                label: '秀山土家族苗族自治县',
            },
            {
                children: [
                    { value: '500235002', label: '青龙街道' },
                    { value: '500235003', label: '人和街道' },
                    { value: '500235001', label: '双江街道' },
                    { value: '500235118', label: '渠马镇' },
                    { value: '500235219', label: '石门乡' },
                    { value: '500235004', label: '盘龙街道' },
                    { value: '500235115', label: '路阳镇' },
                    { value: '500235116', label: '农坝镇' },
                    { value: '500235131', label: '江口镇' },
                    { value: '500235107', label: '故陵镇' },
                    { value: '500235105', label: '龙角镇' },
                    { value: '500235125', label: '凤鸣镇' },
                    { value: '500235124', label: '鱼泉镇' },
                    { value: '500235127', label: '宝坪镇' },
                    { value: '500235108', label: '红狮镇' },
                    { value: '500235121', label: '黄石镇' },
                    { value: '500235133', label: '平安镇' },
                    { value: '500235123', label: '沙市镇' },
                    { value: '500235122', label: '巴阳镇' },
                    { value: '500235147', label: '大阳镇' },
                    { value: '500235146', label: '耀灵镇' },
                    { value: '500235145', label: '后叶镇' },
                    { value: '500235144', label: '龙洞镇' },
                    { value: '500235129', label: '双土镇' },
                    { value: '500235128', label: '南溪镇' },
                    { value: '500235138', label: '双龙镇' },
                    { value: '500235139', label: '泥溪镇' },
                    { value: '500235136', label: '云安镇' },
                    { value: '500235218', label: '洞鹿乡' },
                    { value: '500235137', label: '栖霞镇' },
                    { value: '500235143', label: '堰坪镇' },
                    { value: '50023514', label: '蔈草镇' },
                    { value: '500235239', label: '上坝乡' },
                    { value: '50023513', label: '桑坪镇' },
                    { value: '500235242', label: '清水土家族自治乡' },
                    { value: '500235142', label: '水口镇' },
                    { value: '500235135', label: '云阳镇' },
                    { value: '500235141', label: '养鹿镇' },
                    { value: '500235216', label: '普安乡' },
                    { value: '500235132', label: '高阳镇' },
                    { value: '500235215', label: '新津乡' },
                    { value: '500235208', label: '外郎乡' },
                ],
                value: '500235',
                label: '云阳县',
            },
            {
                children: [
                    { value: '500229002', label: '复兴街道' },
                    { value: '500229001', label: '葛城街道' },
                    { value: '500229201', label: '龙田乡' },
                    { value: '500229202', label: '北屏乡' },
                    { value: '500229205', label: '左岚乡' },
                    { value: '500229221', label: '河鱼乡' },
                    { value: '500229111', label: '高楠镇' },
                    { value: '500229208', label: '沿河乡' },
                    { value: '50022921', label: '双河乡' },
                    { value: '50022922', label: '厚坪乡' },
                    { value: '500229212', label: '鸡鸣乡' },
                    { value: '500229108', label: '高燕镇' },
                    { value: '500229211', label: '蓼子乡' },
                    { value: '500229216', label: '明中乡' },
                    { value: '500229217', label: '治平乡' },
                    { value: '500229214', label: '周溪乡' },
                    { value: '500229102', label: '巴山镇' },
                    { value: '500229103', label: '坪坝镇' },
                    { value: '500229219', label: '岚天乡' },
                    { value: '500229106', label: '修齐镇' },
                    { value: '500229107', label: '高观镇' },
                    { value: '500229104', label: '庙坝镇' },
                    { value: '500229105', label: '明通镇' },
                    { value: '50022911', label: '咸宜镇' },
                    { value: '500229109', label: '东安镇' },
                ],
                value: '500229',
                label: '城口县',
            },
            {
                children: [
                    { value: '500228123', label: '大观镇' },
                    { value: '500228122', label: '柏家镇' },
                    { value: '500228121', label: '石安镇' },
                    { value: '500228111', label: '明达镇' },
                    { value: '500228126', label: '星桥镇' },
                    { value: '500228001', label: '梁平县梁山街道' },
                    { value: '500228002', label: '梁平县双桂街道' },
                    { value: '500228124', label: '竹山镇' },
                    { value: '500228114', label: '回龙镇' },
                    { value: '500228104', label: '屏锦镇' },
                    { value: '500228107', label: '新盛镇' },
                    { value: '500228106', label: '袁驿镇' },
                    { value: '500228101', label: '仁贤镇' },
                    { value: '500228113', label: '和林镇' },
                    { value: '500228103', label: '云龙镇' },
                    { value: '500228102', label: '礼让镇' },
                    { value: '5002282', label: '安胜乡' },
                    { value: '500228109', label: '金带镇' },
                    { value: '500228108', label: '福禄镇' },
                    { value: '5002284', label: '梁平县农场' },
                    { value: '500228119', label: '文化镇' },
                    { value: '500228116', label: '虎城镇' },
                    { value: '500228117', label: '七星镇' },
                    { value: '500228127', label: '曲水镇' },
                    { value: '500228125', label: '蟠龙镇' },
                    { value: '50022811', label: '聚奎镇' },
                    { value: '50022812', label: '合兴镇' },
                    { value: '500228115', label: '碧山镇' },
                    { value: '500228118', label: '龙门镇' },
                    { value: '500228401', label: '梁平县双桂工业园区' },
                    { value: '500228112', label: '荫平镇' },
                    { value: '500228205', label: '紫照乡' },
                    { value: '500228202', label: '龙胜乡' },
                    { value: '500228203', label: '复平乡' },
                    { value: '500228201', label: '铁门乡' },
                ],
                value: '500228',
                label: '梁平县',
            },
            {
                children: [
                    { value: '500238242', label: '中梁乡' },
                    { value: '500238115', label: '菱角镇' },
                    { value: '50023811', label: '峰灵镇' },
                    { value: '500238103', label: '上磺镇' },
                    { value: '500238237', label: '花台乡' },
                    { value: '500238104', label: '古路镇' },
                    { value: '500238105', label: '文峰镇' },
                    { value: '5002381', label: '城厢镇' },
                    { value: '500238107', label: '白鹿镇' },
                    { value: '500238117', label: '土城镇' },
                    { value: '500238101', label: '凤凰镇' },
                    { value: '500238102', label: '宁厂镇' },
                    { value: '5002384', label: '红池坝经济开发区' },
                    { value: '500238243', label: '天元乡' },
                    { value: '500238239', label: '兰英乡' },
                    { value: '500238001', label: '宁河街道' },
                    { value: '500238109', label: '下堡镇' },
                    { value: '500238002', label: '柏杨街道' },
                    { value: '500238113', label: '田坝镇' },
                    { value: '500238208', label: '天星乡' },
                    { value: '500238111', label: '塘坊镇' },
                    { value: '500238112', label: '朝阳镇' },
                    { value: '500238207', label: '大河乡' },
                    { value: '500238108', label: '尖山镇' },
                    { value: '500238204', label: '胜利乡' },
                    { value: '500238106', label: '徐家镇' },
                    { value: '500238227', label: '乌龙乡' },
                    { value: '500238226', label: '鱼鳞乡' },
                    { value: '500238234', label: '中岗乡' },
                    { value: '500238114', label: '通城镇' },
                    { value: '50023821', label: '长桂乡' },
                    { value: '50023824', label: '双阳乡' },
                    { value: '500238116', label: '蒲莲镇' },
                ],
                value: '500238',
                label: '巫溪县',
            },
            ...
            {
                children: [
                    { value: '500243106', label: '黄家镇' },
                    { value: '500243107', label: '普子镇' },
                    { value: '500243104', label: '桑柘镇' },
                    { value: '500243105', label: '鹿角镇' },
                    { value: '500243102', label: '郁山镇' },
                    { value: '500243103', label: '高谷镇' },
                    { value: '500243113', label: '新田镇' },
                    { value: '500243101', label: '保家镇' },
                    { value: '500243211', label: '芦塘乡' },
                    { value: '500243224', label: '石盘乡' },
                    { value: '500243003', label: '靛水街道' },
                    { value: '500243002', label: '绍庆街道' },
                    { value: '500243001', label: '汉葭街道' },
                    { value: '500243109', label: '连湖镇' },
                    { value: '500243114', label: '鞍子镇' },
                    { value: '500243116', label: '龙溪镇' },
                    { value: '500243108', label: '龙射镇' },
                    { value: '500243217', label: '诸佛乡' },
                    { value: '500243111', label: '平安镇' },
                    { value: '50024311', label: '万足镇' },
                    { value: '500243226', label: '润溪乡' },
                    { value: '500243228', label: '龙塘乡' },
                    { value: '50024321', label: '走马乡' },
                    { value: '500243112', label: '长生镇' },
                    { value: '500243117', label: '梅子垭镇' },
                    { value: '500243223', label: '双龙乡' },
                    { value: '500243222', label: '善感乡' },
                    { value: '500243115', label: '太原镇' },
                    { value: '500243227', label: '朗溪乡' },
                    { value: '500243208', label: '石柳乡' },
                    { value: '500243225', label: '大垭乡' },
                    { value: '500243219', label: '桐楼乡' },
                    { value: '500243118', label: '大同镇' },
                    { value: '500243204', label: '棣棠乡' },
                    { value: '500243207', label: '联合乡' },
                    { value: '500243206', label: '三义乡' },
                    { value: '500243201', label: '岩东乡' },
                    { value: '500243213', label: '乔梓乡' },
                    { value: '500243202', label: '鹿鸣乡' },
                ],
                value: '500243',
                label: '彭水苗族土家族自治县',
            },
            {
                children: [
                    { value: '500242218', label: '车田乡' },
                    { value: '500242114', label: '板溪镇' },
                    { value: '500242112', label: '苍岭镇' },
                    { value: '50024221', label: '后坪乡' },
                    { value: '500242217', label: '南腰界乡' },
                    { value: '50024222', label: '清泉乡' },
                    { value: '500242215', label: '板桥乡' },
                    { value: '500242209', label: '花田乡' },
                    { value: '50024211', label: '泔溪镇' },
                    { value: '500242224', label: '楠木乡' },
                    { value: '500242211', label: '天馆乡' },
                    { value: '500242222', label: '浪坪乡' },
                    { value: '500242206', label: '五福乡' },
                    { value: '500242111', label: '酉水河镇' },
                    { value: '500242223', label: '双泉乡' },
                    { value: '500242219', label: '腴地乡' },
                    { value: '500242221', label: '庙溪乡' },
                    { value: '500242202', label: '铜鼓乡' },
                    { value: '500242001', label: '桃花源街道' },
                    { value: '500242002', label: '钟多街道' },
                    { value: '500242216', label: '官清乡' },
                    { value: '500242208', label: '毛坝乡' },
                    { value: '500242214', label: '两罾乡' },
                    { value: '500242101', label: '龙潭镇' },
                    { value: '500242113', label: '小河镇' },
                    { value: '500242103', label: '酉酬镇' },
                    { value: '500242102', label: '麻旺镇' },
                    { value: '500242105', label: '兴隆镇' },
                    { value: '500242104', label: '大溪镇' },
                    { value: '500242107', label: '丁市镇' },
                    { value: '500242106', label: '黑水镇' },
                    { value: '500242109', label: '李溪镇' },
                    { value: '500242108', label: '龚滩镇' },
                    { value: '500242213', label: '万木乡' },
                    { value: '500242212', label: '宜居乡' },
                    { value: '5002422', label: '涂市乡' },
                    { value: '500242207', label: '木叶乡' },
                    { value: '500242204', label: '可大乡' },
                    { value: '500242205', label: '偏柏乡' },
                ],
                value: '500242',
                label: '酉阳土家族苗族自治县',
            },
            {
                children: [
                    { value: '500240114', label: '桥头镇' },
                    { value: '500240115', label: '万朝镇' },
                    { value: '500240116', label: '冷水镇' },
                    { value: '500240117', label: '黄鹤镇' },
                    { value: '500240111', label: '鱼池镇' },
                    { value: '500240112', label: '三河镇' },
                    { value: '500240113', label: '大歇镇' },
                    { value: '500240219', label: '金竹乡' },
                    { value: '500240218', label: '金铃乡' },
                    { value: '500240217', label: '新乐乡' },
                    { value: '500240216', label: '龙潭乡' },
                    { value: '500240214', label: '洗新乡' },
                    { value: '500240213', label: '中益乡' },
                    { value: '500240212', label: '枫木乡' },
                    { value: '50024011', label: '龙沙镇' },
                    { value: '500240109', label: '沿溪镇' },
                    { value: '500240108', label: '王场镇' },
                    { value: '500240', label: '下路街道' },
                    { value: '500240103', label: '悦崃镇' },
                    { value: '500240101', label: '西沱镇' },
                    { value: '500240107', label: '沙子镇' },
                    { value: '500240106', label: '马武镇' },
                    { value: '500240105', label: '黄水镇' },
                    { value: '500240104', label: '临溪镇' },
                    { value: '500240203', label: '黎场乡' },
                    { value: '500240204', label: '三星乡' },
                    { value: '500240205', label: '六塘乡' },
                    { value: '500240207', label: '三益乡' },
                    { value: '500240208', label: '王家乡' },
                    { value: '500240209', label: '河嘴乡' },
                    { value: '50024021', label: '石家乡' },
                ],
                value: '500240',
                label: '石柱土家族自治县',
            },
    ...
    },
    {
        children: [
            ...
            {
                children: [
                    { value: '65900252', label: '兵团三团' },
                    { value: '6590025', label: '兵团七团' },
                    { value: '6590022', label: '托喀依乡' },
                    { value: '659002515', label: '中心监狱' },
                    { value: '659002514', label: '兵团第一师幸福农场' },
                    { value: '659002517', label: '兵团农一师沙井子水利管理处' },
                    { value: '659002516', label: '兵团一团' },
                    { value: '659002511', label: '兵团第一师水利水电工程处' },
                    { value: '659002513', label: '阿拉尔农场' },
                    {
                        value: '659002512',
                        label: '兵团第一师塔里木灌区水利管理处',
                    },
                    { value: '659002003', label: '青松路街道' },
                    { value: '659002002', label: '幸福路街道' },
                    { value: '659002001', label: '金银川路街道' },
                    { value: '659002519', label: '兵团二团' },
                    { value: '659002518', label: '西工业园区管理委员会' },
                    { value: '659002004', label: '南口街道' },
                    { value: '659002506', label: '兵团十三团' },
                    { value: '659002507', label: '兵团十四团' },
                    { value: '659002504', label: '兵团十一团' },
                    { value: '659002505', label: '兵团十二团' },
                    { value: '659002503', label: '兵团十团' },
                    { value: '659002501', label: '兵团八团' },
                    { value: '659002402', label: '工业园区' },
                    { value: '659002509', label: '兵团十六团' },
                ],
                value: '659002',
                label: '阿拉尔市',
            },
            ...
            {
                children: [
                    { value: '659003509', label: '兵团四十九团' },
                    { value: '659003513', label: '兵团五十三团' },
                    { value: '659003001', label: '齐干却勒街道' },
                    { value: '659003002', label: '前海街道' },
                    { value: '659003003', label: '永安坝街道' },
                    { value: '65900351', label: '兵团五十团' },
                    { value: '659003511', label: '兵团五十一团' },
                    { value: '659003504', label: '兵团四十四团' },
                    { value: '659003514', label: '兵团图木舒克市喀拉拜勒镇' },
                ],
                value: '659003',
                label: '图木舒克市',
            },
            {
                children: [
                    { value: '659001101', label: '石河子镇' },
                    { value: '6590011', label: '北泉镇' },
                    { value: '659001004', label: '老街街道' },
                    { value: '659001005', label: '东城街道' },
                    { value: '659001002', label: '向阳街道' },
                    { value: '6590015', label: '兵团一五二团' },
                    { value: '659001003', label: '红山街道' },
                    { value: '659001001', label: '新城街道' },
                ],
                value: '659001',
                label: '石河子市',
            },
            ...
            {
                children: [
                    { value: '6590045', label: '兵团一零一团' },
                    { value: '659004501', label: '兵团一零二团' },
                    { value: '659004502', label: '兵团一零三团' },
                    { value: '659004001', label: '军垦路街道' },
                    { value: '659004003', label: '人民路街道' },
                    { value: '659004002', label: '青湖路街道' },
                ],
                value: '659004',
                label: '五家渠市',
            },
